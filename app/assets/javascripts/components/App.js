  ...
  render: function() {
    return (
      <div style={{background:"whitesmoke"}}>
        ...
        <RouteHandler session={this.state.session} openSignIn={this.openSignIn} openSignUp={this.openSignUp} appConfig={this.props.appConfig} dataStore={this.state.dataStore} />
