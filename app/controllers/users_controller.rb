class UsersController < ApplicationController
  ...
  def index
    ...
    respond_to do |format|
      ...
      format.json { render json: users.as_json(include: :services, methods: [:raterCount, :averageRating]), status: :ok }
    end
  end
  ...
  def show
    ...
    respond_to do |format|
      format.html { render 'shared/meta'}
      format.json { render json: user.as_json(include: :services, methods: [:raterCount, :averageRating]), status: :ok }
    end
  end
  ...
  private
    ...
    def user_params
      params.permit(:banner_image, :avatar, :nickname, :position, :headline, :portfolio, :profile)
    end
